...
This document provides the detailed technical specification for UCP. For a complete definition of all data models and schemas, see the \[Schema Reference\](https://ucp.dev/documentation/core-concepts/{"message":"Not Found","documentation_url":"https:/docs.github.com/rest/pages/pages/latest/specification/reference).
